...
function copyBillingToShipping() {
	var l_oForm = document.billingInfo;

	if (l_oForm.cbCopyBillToShip.checked) {
		l_oForm.firstNameShip.value = l_oForm.firstName.value;
		l_oForm.lastNameShip.value = l_oForm.lastName.value;
		l_oForm.address1Ship.value = l_oForm.address1.value;
		l_oForm.address2Ship.value = l_oForm.address2.value;
		l_oForm.cityShip.value = l_oForm.city.value;
		l_oForm.stateShip.value = l_oForm.state.value;
		l_oForm.zipShip.value = l_oForm.zip.value;
		l_oForm.phoneShip.value = l_oForm.phone.value;
	}
}
...
//**************************************************************************************
function RedirectToURL(btnObj, url, isShiptostoreFlow) {
    try {
        var IsShipToStore = (isShiptostoreFlow == "True") ? true : false;
		if (IsShipToStore) {
